# -*- coding: utf-8 -*-
"""
Created on Sun Mar  1 11:54:42 2020
...
with open("/content/drive/My Drive/AlteGrad/fichiers/train.csv", 'r') as f:
...
# Test data
# Read test data
with open("/content/drive/My Drive/AlteGrad/fichiers/test.csv", 'r') as f:
...
G = nx.read_weighted_edgelist('/content/drive/My Drive/AlteGrad/fichiers/edgelist.txt', create_using=nx.DiGraph())
n = len(train_hosts)
n_dim = 3
n_walks = 100
walk_length = 200
